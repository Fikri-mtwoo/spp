...
class bukuModel extends CI_Model {
    var $table = 'tabel_buku';
    var $kolom_order = array(null, 'id_buku');
    var $kolom_cari = array('nama_buku');
    ...
    public function insert($data){
        return $this->db->insert('tabel_buku', $data);
    }
    ...
    public function update($id, $data){
        ...
        return $this->db->update('tabel_buku', $data);
    }

    public function delete($id){
        $this->db->where('id_buku', $id);
        return $this->db->delete('tabel_buku');
    }
}