...
class jurusanModel extends CI_Model{
    var $table = 'tabel_jurusan';
    var $kolom_order = array(null, 'id_jurusan');
    var $kolom_cari = array('nama_jurusan');
    ...
    public function insert($data){
        return $this->db->insert('tabel_jurusan', $data);
    }
    ...
    public function update($id, $data){
        ...
        return $this->db->update('tabel_jurusan', $data);
    }

    public function delete($id){
        $this->db->where('id_jurusan', $id);
        return $this->db->delete('tabel_jurusan');
    }
}
?>