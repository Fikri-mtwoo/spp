                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="number" class="form-control <?=(form_error('nama_kelas')? 'is-invalid':'')?>" name="nama_kelas" placeholder="10">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" class="form-control <?=(form_error('romawi')? 'is-invalid':'')?>" name="romawi" placeholder="X">
                                            <?= form_error('romawi')?>
                                        </div>
                                        <!-- <div class="col-md-4">
