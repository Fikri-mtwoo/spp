            ...
            <div class="col-md-4 col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-horizontal" action="<?=base_url('transaksigedung/proses_edit')?>" method="POST">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <input type="text" name="keterangan" class="form-control" value="<?=$transaksi->keterangan?>" >
                                            <input type="hidden" name="id" value="<?=$transaksi->id_transaksi_gedung?>">
                                        </div>
                                        <div class="col-md-12 form-group">
                            ...
                            <form class="form form-horizontal">
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 form-group">
                                            <input type="text" name="keterangan" class="form-control" placeholder="Cicilan ke 1">
                                        </div>
                                        <div class="col-md-4 form-group">
