            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?=base_url('transaksipendaftaran')?>">Transaksi Pendaftaran</a></li>
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 d-flex justify-content-end">
                                            <button type="button"class="btn btn-block btn-primary me-1 mb-1 transaksi-pendaftaran">Cari</button>
                                        </div>
                                    </div>
                                </div>
                            </form>     
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            <input type="text" name="keterangan" class="form-control" placeholder="Keterangan transaksi pendaftaran" readonly>
                                            <input type="hidden" name="id" >
                                            <input type="hidden" name="nisn" >
                                        </div>
                                        <div class="col-md-6 form-group">
                                            <input type="number" name="jumlah_bayar" class="form-control" placeholder="Rp 0" readonly>
                                        </div>
                                        <div class="col-sm-12 d-flex justify-content-end">
                                            <button type="button"class="btn btn-block btn-success me-1 mb-1 bayar-pendaftaran" >Bayar</button>
                                        </div>
                                    </div>
                                </div>
                            </form>     
    ...
    <section id="basic-horizontal-layouts " class="history d-none">
        <div class="row match-height justify-content-center">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form action="<?=base_url('transaksipendaftaran/export')?>" method="post">
                                <div class="row">
                                    <div class="col-md-2">
                                        <input type="hidden" name="nisn">
