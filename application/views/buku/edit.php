                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" class="form-control <?=(form_error('nama_buku')? 'is-invalid':'')?>" name="nama_buku" placeholder="Buku LKS Seni Budaya" value="<?=$buku->nama_buku?>">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="number" class="form-control <?=(form_error('harga')? 'is-invalid':'')?>" name="harga" placeholder="100000" value="<?=$buku->harga_buku?>">
                                            <?= form_error('harga')?>
                                        </div>
                                        <!-- <div class="col-md-4">
