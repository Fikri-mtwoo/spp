            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?=base_url('transaksibuku')?>">Transaksi Buku</a></li>
    ...
    <section id="basic-horizontal-layouts">
        <div class="row match-height justify-content-center">
            <div class="col-md-4 col-12">
                <div class="alert alert-danger alert-dismissible show fade d-none alert-tagihan-buku">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 d-flex justify-content-end">
                                            <button type="button"class="btn btn-block btn-primary me-1 mb-1 transaksi-buku">Cari</button>
                                        </div>
                                    </div>
                                </div>
                            </form>     
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <input type="text" name="kelas" class="form-control" placeholder="10 RPL A" disabled>
                                            </div>
                                            <div class="form-group">
                                                <input type="text" name="sisa_bayar" class="form-control" placeholder="Rp 0" readonly>
                                        ...
                                        <div class="col-md-8">
                                            <div class="row">
                                                <div class="col-md-6 form-group">
                                                    <input type="text" name="keterangan" class="form-control" placeholder="Keterangan transaksi buku">
                                                </div>
                                                <div class="col-md-6 form-group">
                                                    <input type="number" name="jumlah_bayar" class="form-control">
                                                </div>
                                                <div class="col-sm-12 d-flex justify-content-end">
                                                    <button type="button"class="btn btn-block btn-success me-1 mb-1 bayar-buku" >Bayar</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <section id="basic-horizontal-layouts " class="history d-none">
        <div class="row match-height justify-content-center">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form action="<?=base_url('transaksibuku/export')?>" method="post">
                                <div class="row">
                                    <div class="col-md-2">
                                        <input type="hidden" name="nisn">
                            ...
                            <div class="card-body table-responsive">
                                <table class="table table-striped table-bordered" >
                                    ...
                                    <tbody id="tabelHistoriTransaksiBuku"></tbody>
                                </table>
                            </div>
                        </div>
                    </div>
